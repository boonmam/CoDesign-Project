set moduleName clusterOp_Pipeline_VITIS_LOOP_73_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clusterOp_Pipeline_VITIS_LOOP_73_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ clusters_num_points_load int 32 regular  }
	{ phi_mul int 13 regular  }
	{ clusters_points int 32 regular {array 7200 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "clusters_num_points_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "phi_mul", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
 	{ "Name" : "clusters_points", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sub88", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "cmp91", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ out_clusters_TREADY sc_in sc_logic 1 outacc 5 } 
	{ clusters_num_points_load sc_in sc_lv 32 signal 0 } 
	{ phi_mul sc_in sc_lv 13 signal 1 } 
	{ clusters_points_address0 sc_out sc_lv 13 signal 2 } 
	{ clusters_points_ce0 sc_out sc_logic 1 signal 2 } 
	{ clusters_points_q0 sc_in sc_lv 32 signal 2 } 
	{ sub88 sc_in sc_lv 32 signal 3 } 
	{ cmp91 sc_in sc_lv 1 signal 4 } 
	{ out_clusters_TDATA sc_out sc_lv 32 signal 5 } 
	{ out_clusters_TVALID sc_out sc_logic 1 outvld 11 } 
	{ out_clusters_TKEEP sc_out sc_lv 4 signal 6 } 
	{ out_clusters_TSTRB sc_out sc_lv 4 signal 7 } 
	{ out_clusters_TUSER sc_out sc_lv 2 signal 8 } 
	{ out_clusters_TLAST sc_out sc_lv 1 signal 9 } 
	{ out_clusters_TID sc_out sc_lv 5 signal 10 } 
	{ out_clusters_TDEST sc_out sc_lv 6 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_clusters_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "out_clusters_V_data_V", "role": "default" }} , 
 	{ "name": "clusters_num_points_load", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "clusters_num_points_load", "role": "default" }} , 
 	{ "name": "phi_mul", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "phi_mul", "role": "default" }} , 
 	{ "name": "clusters_points_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "clusters_points", "role": "address0" }} , 
 	{ "name": "clusters_points_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "clusters_points", "role": "ce0" }} , 
 	{ "name": "clusters_points_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "clusters_points", "role": "q0" }} , 
 	{ "name": "sub88", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sub88", "role": "default" }} , 
 	{ "name": "cmp91", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "cmp91", "role": "default" }} , 
...
set Spec2ImplPortList { 
	clusters_num_points_load { ap_none {  { clusters_num_points_load in_data 0 32 } } }
	phi_mul { ap_none {  { phi_mul in_data 0 13 } } }
	clusters_points { ap_memory {  { clusters_points_address0 mem_address 1 13 }  { clusters_points_ce0 mem_ce 1 1 }  { clusters_points_q0 in_data 0 32 } } }
	sub88 { ap_none {  { sub88 in_data 0 32 } } }
	cmp91 { ap_none {  { cmp91 in_data 0 1 } } }
	out_clusters_V_data_V { axis {  { out_clusters_TREADY out_acc 0 1 }  { out_clusters_TDATA out_data 1 32 } } }
	...
	out_clusters_V_dest_V { axis {  { out_clusters_TVALID out_vld 1 1 }  { out_clusters_TDEST out_data 1 6 } } }
}
