...
module clusterOp2_clusterOp2_Pipeline_VITIS_LOOP_201_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln203_fu_171_p1;
reg   [30:0] j_fu_76;
wire   [30:0] add_ln201_fu_155_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_j_2;
reg    ap_block_pp0_stage0_01001;
wire   [16:0] trunc_ln203_fu_161_p1;
wire   [16:0] add_ln203_fu_165_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln201_fu_149_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln201_fu_149_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln201_fu_155_p2 = (ap_sig_allocacmp_j_2 + 31'd1);

assign add_ln203_fu_165_p2 = (phi_mul + trunc_ln203_fu_161_p1);
...
assign clusters_members_address0 = zext_ln203_fu_171_p1;

assign icmp_ln201_fu_149_p2 = ((ap_sig_allocacmp_j_2 == trunc_ln) ? 1'b1 : 1'b0);
...
assign trunc_ln203_fu_161_p1 = ap_sig_allocacmp_j_2[16:0];

assign zext_ln203_fu_171_p1 = add_ln203_fu_165_p2;

endmodule //clusterOp2_clusterOp2_Pipeline_VITIS_LOOP_201_3
