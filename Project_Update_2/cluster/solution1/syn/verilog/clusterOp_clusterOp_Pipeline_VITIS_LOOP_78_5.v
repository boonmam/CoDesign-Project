...
module clusterOp_clusterOp_Pipeline_VITIS_LOOP_78_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln80_fu_184_p1;
reg   [30:0] j_fu_74;
wire   [30:0] add_ln78_fu_168_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_j_1;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] j_cast_fu_158_p1;
wire   [16:0] trunc_ln80_fu_174_p1;
wire   [16:0] add_ln80_fu_178_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln78_fu_162_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln78_fu_162_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_last_V_reg_231 <= tmp_last_V_fu_195_p2;
    end
end

always @ (*) begin
    if (((icmp_ln78_fu_162_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln78_fu_168_p2 = (ap_sig_allocacmp_j_1 + 31'd1);

assign add_ln80_fu_178_p2 = (phi_mul + trunc_ln80_fu_174_p1);
...
assign clusters_members_address0 = zext_ln80_fu_184_p1;

assign icmp_ln78_fu_162_p2 = (($signed(j_cast_fu_158_p1) < $signed(clusters_member_count_load)) ? 1'b1 : 1'b0);

assign icmp_ln85_fu_189_p2 = ((j_cast_fu_158_p1 == sub103) ? 1'b1 : 1'b0);

assign j_cast_fu_158_p1 = ap_sig_allocacmp_j_1;
...
assign tmp_last_V_fu_195_p2 = (icmp_ln85_fu_189_p2 & cmp107);

assign trunc_ln80_fu_174_p1 = ap_sig_allocacmp_j_1[16:0];

assign zext_ln80_fu_184_p1 = add_ln80_fu_178_p2;

endmodule //clusterOp_clusterOp_Pipeline_VITIS_LOOP_78_5
