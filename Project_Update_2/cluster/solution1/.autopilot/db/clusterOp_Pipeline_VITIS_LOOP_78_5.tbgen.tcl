set moduleName clusterOp_Pipeline_VITIS_LOOP_78_5
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "clusters_member_count_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sub103", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "cmp107", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sub103 sc_in sc_lv 32 signal 3 } 
	{ cmp107 sc_in sc_lv 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub103", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sub103", "role": "default" }} , 
 	{ "name": "cmp107", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "cmp107", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sub103 { ap_none {  { sub103 in_data 0 32 } } }
	cmp107 { ap_none {  { cmp107 in_data 0 1 } } }
