...
__attribute__((sdx_kernel("clusterOp", 0))) void clusterOp(hls::stream<stream_axis> &in_angle, hls::stream<stream_axis> &in_distance, hls::stream<stream_axis> &out_clusters) {
#line 16 "Z:/Documents/CodesignProject/cluster/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=clusterOp
# 15 "cluster/cluster.cpp"
...
#pragma HLS INTERFACE axis port=out_clusters
 ...
 const int D_th = 100;
    ...
    VITIS_LOOP_38_2: for (int point = 0; point < 360; point++) {
        ...
        VITIS_LOOP_50_3: for (int i = 0; i < 360; i++) {
    ...
    VITIS_LOOP_72_4: for (int i = 0; i < num_clusters; i++) {
        VITIS_LOOP_73_5: for (int j = 0; j < clusters[i].num_points; j++) {
