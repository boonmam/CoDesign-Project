...
set C_modelArgMapList {[ 
	{ "Name" : "clusters_member_count_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sub89", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ outStream_TREADY sc_in sc_logic 1 outacc 5 } 
	...
	{ sub89 sc_in sc_lv 32 signal 3 } 
	{ tmp_id_V sc_in sc_lv 5 signal 4 } 
	{ outStream_TDATA sc_out sc_lv 32 signal 5 } 
	{ outStream_TVALID sc_out sc_logic 1 outvld 11 } 
	{ outStream_TKEEP sc_out sc_lv 4 signal 6 } 
	{ outStream_TSTRB sc_out sc_lv 4 signal 7 } 
	{ outStream_TUSER sc_out sc_lv 2 signal 8 } 
	{ outStream_TLAST sc_out sc_lv 1 signal 9 } 
	{ outStream_TID sc_out sc_lv 5 signal 10 } 
	{ outStream_TDEST sc_out sc_lv 6 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub89", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sub89", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sub89 { ap_none {  { sub89 in_data 0 32 } } }
