...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStream_TVALID { I 1 bit } inStream_TDATA { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename distances \
    op interface \
    ports { distances_address0 { O 9 vector } distances_ce0 { O 1 bit } distances_we0 { O 1 bit } distances_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename visited \
    op interface \
    ports { visited_address0 { O 9 vector } visited_ce0 { O 1 bit } visited_we0 { O 1 bit } visited_d0 { O 1 vector } } \
} "
} else {
