...
module clusterOp2_clusterOp2_Pipeline_VITIS_LOOP_194_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [30:0] j_fu_74;
wire   [30:0] add_ln194_fu_168_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_j_2;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] j_cast_fu_158_p1;
wire   [16:0] trunc_ln196_fu_174_p1;
wire   [16:0] add_ln196_fu_178_p2;
wire   [0:0] icmp_ln201_1_fu_189_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln194_fu_162_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln194_fu_162_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_last_V_reg_231 <= tmp_last_V_fu_195_p2;
    end
end

always @ (*) begin
    if (((icmp_ln194_fu_162_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln194_fu_168_p2 = (ap_sig_allocacmp_j_2 + 31'd1);

assign add_ln196_fu_178_p2 = (phi_mul + trunc_ln196_fu_174_p1);
...
assign clusters_members_address0 = zext_ln196_fu_184_p1;

assign icmp_ln194_fu_162_p2 = (($signed(j_cast_fu_158_p1) < $signed(clusters_member_count_load)) ? 1'b1 : 1'b0);

assign icmp_ln201_1_fu_189_p2 = ((j_cast_fu_158_p1 == sub) ? 1'b1 : 1'b0);
...
assign tmp_last_V_fu_195_p2 = (icmp_ln201_1_fu_189_p2 & icmp_ln201);

assign trunc_ln196_fu_174_p1 = ap_sig_allocacmp_j_2[16:0];

assign zext_ln196_fu_184_p1 = add_ln196_fu_178_p2;

endmodule //clusterOp2_clusterOp2_Pipeline_VITIS_LOOP_194_3
