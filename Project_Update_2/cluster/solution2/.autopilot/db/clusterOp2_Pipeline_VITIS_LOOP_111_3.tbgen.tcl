set moduleName clusterOp2_Pipeline_VITIS_LOOP_111_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clusterOp2_Pipeline_VITIS_LOOP_111_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "clusters_member_count_load", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "icmp_ln118", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ icmp_ln118 sc_in sc_lv 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "icmp_ln118", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln118", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	icmp_ln118 { ap_none {  { icmp_ln118 in_data 0 1 } } }
